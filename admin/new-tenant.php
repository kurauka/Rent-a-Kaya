<?php 
    ...
    //a page name
    $pgnm='Rent-a-Kaya: Admit a tenant';
    $error=' ';
                        ...
                        */
                        ...
                        $mysqli->query($sql_transactions)?null: $status=false;
                            ...
                            if ($status) {
                                ...
                                $finalmessage="Hello ".$firstName.", You're welcome to Rent-a-Kaya. You were admitted to ".$hsname." with rent amount of KES. ".$rentAmount." per month.";
                                    ...
                                    <form action="new-tenant.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="temail" class="form-control" id="temail" placeholder="example@rent-a-kaya.com"> </div>
                                        </div>
