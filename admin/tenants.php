                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    // modernized row: avatar, compact info, and action buttons
                                    $initial = strtoupper(substr($row["tenant_name"],0,1));
                                        ...
                                        <tr>
                                            <td>
                                                <div style='display:flex;gap:12px;align-items:center'>
                                                    <div style='width:44px;height:44px;border-radius:8px;background:linear-gradient(135deg,#e2e8f0,#c7d2fe);display:flex;align-items:center;justify-content:center;font-weight:700;color:#0f172a'>".$initial."</div>
                                                    <div>
                                                        <a href='#' data-toggle='modal' data-target='#edit-modal".$row["tenantID"]."' title='Edit $name' style='color:#03a9f3; font-weight:600;'>$name</a>
                                                        <div style='font-size:12px;color:var(--kaya-muted)'>$email</div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div style='display:flex;gap:8px;align-items:center'>
                                                    <button class='btn btn-sm btn-outline-danger' data-toggle='modal' data-target='#responsive-modal".$row["tenantID"]."' title='Delete $name'><i class='fa fa-trash'></i></button>
                                                    <button class='btn btn-sm btn-outline-primary' data-toggle='modal' data-target='#edit-modal".$row["tenantID"]."' title='Edit $name'><i class='fa fa-edit'></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                    ";

                                    // deletion modal (unchanged logic)
                                    echo "
                                                ...
                                                <div class='modal-dialog'>
                                                    <div class='modal-content'>
                                                        <div class='modal-header'>
                                                            ...
                                                            <h4 class='modal-title'>Are you really sure you want to permanently delete <br><strong>$name</strong>'s record?</h4>
                                                            </div>
                                    ...
                                    // edit modal (reuse existing form fields)
                                    echo "
                                    ...
                                    <form action='functions/del_tenant.php' method='post'>
                                        <div class='form-group'>
                                            ...
                                            <div class='input-group'>
                                                ...
                                                <input type='text' name='tname' class='form-control' value='".$row["tenant_name"]."' id='hname' placeholder='Enter tenant name' required=''> </div>
                                        </div>
                                        <div class='form-group'>
                                            <label for='temail'>Email: </label>
                                            <div class='input-group'>
                                                <div class='input-group-addon'><i class='fa fa-at'></i></div>
                                                <input type='email' name='temail' class='form-control' value='".$row["email"]."' id='temail' placeholder='example@rent-a-kaya.com'> </div>
                                        </div>
                                        <div class='form-group'>
                                            <label for='idnum'>ID Number: *</label>
                                            <div class='input-group'>
                                                <div class='input-group-addon'><i class='fa fa-user'></i></div>
                                                <input type='number' min='1000' required name='idnum' value='".$row["ID_number"]."' class='form-control' id='idnum' placeholder='ID Number...' > </div>
                                        </div>
                                        <div class='form-group'>
                                            <label for='phone'>Phone Number: *</label>
                                            <div class='input-group'>
                                                <div class='input-group-addon'><i class='fa fa-phone'></i></div>
                                                <input type='number' min='0' name='phone' value='".$row["phone_number"]."' class='form-control' id='phone' placeholder='e.g 254 712 345678' required=''> </div>
                                        </div>
                                        <div class='form-group'>
                                            <label for='prof'>Profession: *</label>
                                            <div class='input-group'>
                                                <div class='input-group-addon'><i class='fa fa-briefcase'></i></div>
                                                <input type='text' required name='prof' class='form-control' value='".$row["profession"]."' id='prof' placeholder='e.g. Teacher' required=''> </div>
                                        </div>
                                        <input type='text' name='ten_id' class='form-control' value='".$row["tenantID"]."' hidden>
